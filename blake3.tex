...
\end{tikzpicture}
\caption{An example of a tree growing incrementally from 1 to 4 chunks. Dotted
...
any longer. The CVs that we still need are stored in the CV stack. We can look
