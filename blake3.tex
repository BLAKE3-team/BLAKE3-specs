...
\caption{Cycles-per-byte for a single-threaded implementation of BLAKE3 at
    various input lengths on an Intel Skylake-SP processor. Lower is better.}%
\label{fig:avx512}
\end{figure}
...
\caption{Cycles-per-byte at various input lengths on a 32-bit ARM1176
    processor. Lower is better.}%
\label{fig:rpizero}
\end{figure}
