...
\caption{Throughput for single-threaded BLAKE3 and other hash functions on an
    ...
    Skylake-SP processor with AVX-512 support. Lower is faster.}%
\label{fig:avx512}
\end{figure}
...
\caption{Throughput for multi-threaded BLAKE3 on an AWS c5.metal instance,
    measured in GiB/s, varying the number of threads. This is a
    48-physical-core Intel Skylake-SP processor with AVX-512 support. Higher is
    faster.}%
\label{fig:threads}
\end{figure}
