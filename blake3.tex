...
similar, apart from the number of rounds. Between 1 and 4~KiB, the gap between
BLAKE3 and BLAKE2s closes slightly. This is because BLAKE3 begins dividing its
input into multiple chunks with parent nodes, and compressing the parent nodes
adds overhead. At 4~KiB, BLAKE3 begins compressing multiple chunks in parallel.
Parallel chunk compression can use 128-bit SSE vectors at 4~KiB, 256-bit AVX2
vectors at 8~KiB, and 512-bit AVX-512 vectors at 16~KiB. Beyond 16~KiB,
